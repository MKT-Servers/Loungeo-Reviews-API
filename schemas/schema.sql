...
CREATE TABLE photos (
	photos_id integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE char_name_vote_join (
	char_join_id integer GENERATED BY DEFAULT AS IDENTITY UNIQUE PRIMARY KEY,
	product_id integer NOT NULL,
...
CREATE TABLE temp_characteristic_reviews (
	join_id integer GENERATED BY DEFAULT AS IDENTITY UNIQUE PRIMARY KEY,
